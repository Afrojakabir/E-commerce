...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    <li> <a href="/userorder"><i class="dropdown-item "></i><span>Order</span></a> </li>
     <li> <a href="/user/create"><i class="dropdown-item "></i><span>Order special</span></a> </li>
     <li> <a href="/user/show"><i class="dropdown-item"></i><span>View request</span></a> </li>
  </div>
</div>
   
   
        <a class="nav-link "  href="{{route('homepage.shoppigCart')}}">Cart<i class="fa fa-cart-plus"></i>
